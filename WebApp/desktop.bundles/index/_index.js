...
(function (global)
{
  ...
  var DECL_STATES = {
    ...
    undef, modulesStorage = {}, declsToCalc = [], waitForNextTick = false, pendingRequires = [],
    ...
    {
      var requiresToProcess = pendingRequires, require, i = 0, j, dep, dependOnDecls, applyCb;
    ...
    {
      var unresolvedDeclCnt = decls.length, checkUnresolved = true;
    ...
    startDeclResolving = function (decl, path)
    {
      ...
      requireDecls(decl.dependOnDecls, function (depDeclsExports)
        {
          decl.fn.apply({
              name: decl.name,
              deps: decl.deps,
              global: global
                ...
                {
                  isProvided ? throwDeclAlreadyProvided(decl) : isProvided = true;
    ...
    {
      throwException(Error(decl ? 'Module "' + decl.name + '": can\'t resolve dependence "' + name + '"' : 'Can\'t resolve required module "' + name + '"'));
    },

    throwCircularDependenceDetected = function (decl, path)
    {
      var strPath = [], i = 0, pathDecl;
      while (pathDecl = path[i++]) {
...
modules.define('i-bem', ['inherit', 'identify', 'next-tick', 'objects', 'functions', 'events', 'events__channels'
], function (provide, inherit, identify, nextTick, objects, functions, events, channels)
  {
    ...
    var BEM = inherit(events.Emitter, /** @lends BEM.prototype */ {
      ...
      {
        this.__base(e = this._buildEvent(e), data).__self.trigger(e, data);
      ...
      {
        var len = arguments.length, invert = false;
      ...
      {
        var hasElem = elem && typeof elem !== 'string', modNames = [].slice.call(arguments, hasElem ? 1 : 0), res = this._extractMods(modNames, hasElem ? elem : undef);
      ...
      setMod: function (elem, modName, modVal)
      {
        ...
        if (!elem || elem[0]) {
          ...
          var elemName, curModVal = elem ? this._getElemMod(modName, elem, elemName = this.__self._extractElemNameFrom(elem)) : this.getMod(modName);
          ...
          var needSetMod = true, modFnParams = [modName, modVal, curModVal];
          ...
          var modVars = [
              ...
              [modName, '*'],
              [modName, modVal]
            ], prefixes = ['before', 'after'], i = 0, prefix, j, modVar;
      ...
      decl: function (decl, props, staticProps)
      {
        ...
        decl.block === baseBlock._name ? // makes a new "live" if the old one was already executed
          (block = inherit.self(baseBlocks, props, staticProps))._processLive(true) : (block = blocks[decl.block] = inherit(baseBlocks, props, staticProps))._name = decl.block;
...
modules.define('inherit', function (provide)
{
  ...
  var hasIntrospection = (function ()
    {
      '_';
    }).toString().indexOf('_') > -1, emptyBase = function ()
    {
    ...
    }, extend = function (o1, o2)
    {
      ...
      return o1;
    }, toStr = Object.prototype.toString, isArray = Array.isArray || function (obj)
    {
    ...
    {
    }, needCheckProps = true, testPropObj = { toString: '' };
  ...
  {
    var addList = getPropList(add), j = 0, len = addList.length, name, prop;
    while (j < len) {
  ...
  {
    var args = arguments, withMixins = isArray(args[0]), hasBase = withMixins || isFunction(args[0]), base = hasBase ? withMixins ? applyMixins(args[0]) : args[0] : emptyBase, props = args[hasBase ? 1 : 0] || {}, staticProps = args[hasBase ? 2 : 1], res = props.__constructor || (hasBase && base.prototype.__constructor) ? function ()
      {
    ...
    var basePtp = base.prototype, resPtp = res.prototype = objCreate(basePtp);
  ...
  {
    var args = arguments, withMixins = isArray(args[0]), base = withMixins ? applyMixins(args[0], args[0][0]) : args[0], props = args[1], staticProps = args[2], basePtp = base.prototype;
...
modules.define('next-tick', function (provide)
{
  ...
  var global = this.global, fns = [], enqueueFn = function (fn)
    {
      return fns.push(fn) === 1;
    }, callFns = function ()
    {
  ...
  if (global.postMessage) { // modern browsers
    ...
    if (isPostMessageAsync) {
      var msg = '__nextTick' + (+new Date), onMessage = function (e)
        {
          if (e.data === msg) {
            e.stopPropagation && e.stopPropagation();
            callFns();
...
modules.define('events', ['identify', 'inherit', 'functions'], function (provide, identify, inherit, functions)
  {
    ...
    var undef, storageExpando = '__' + (+new Date) + 'storage', getFnId = function (fn, ctx)
      {
      ...
      EmitterProps = {
        ...
        on: function (e, data, fn, ctx, _special)
        {
          if (typeof e === 'string') {
            ...
            var id = getFnId(fn, ctx), storage = this[storageExpando] || (this[storageExpando] = {}), eventTypes = e.split(' '), eventType, i = 0, list, item, eventStorage;
          ...
          if (typeof e === 'string' || typeof e === 'undefined') {
            ...
            if (storage) {
              if (e) { // if event type was passed
                var eventTypes = e.split(' '), i = 0, eventStorage;
                while (e = eventTypes[i++]) {
                  if (eventStorage = storage[e]) {
                    if (fn) {  // if specific handler was passed
                      var id = getFnId(fn, ctx), ids = eventStorage.ids;
                      if (id in ids) {
                        var list = eventStorage.list, item = ids[id], prev = item.prev, next = item.next;
        ...
        emit: function (e, data)
        {
          var storage = this[storageExpando], eventInstantiated = false;

          if (storage) {
            var eventTypes = [typeof e === 'string' ? e : e.type, '*'], i = 0, eventType, eventStorage;
            while (eventType = eventTypes[i++]) {
              if (eventStorage = storage[eventType]) {
                var item = eventStorage.list.first, lastItem = eventStorage.list.last, res;
                while (item) {
     ...
     */
    var Emitter = inherit(/** @lends Emitter.prototype */
      EmitterProps, /** @lends Emitter */
      EmitterProps);
...
(function ()
{
  ...
  var ptp = Array.prototype, toStr = Object.prototype.toString, methods = {
      ...
      {
        var i = -1, t = this, len = t.length, res = new Array(len);
      ...
      {
        var i = -1, t = this, len = t.length, res = [];
...
modules.define('i-bem__dom', ['i-bem', 'i-bem__internal', 'identify', 'objects', 'functions', 'jquery', 'dom'], function (provide, BEM, INTERNAL, identify, objects, functions, $, dom)
  {
    ...
    var undef, win = $(window), doc = $(document),
      ...
      BEM_CLASS = 'i-bem', BEM_SELECTOR = '.' + BEM_CLASS, BEM_PARAMS_ATTR = 'data-bem',

      NAME_PATTERN = INTERNAL.NAME_PATTERN,

      MOD_DELIM = INTERNAL.MOD_DELIM, ELEM_DELIM = INTERNAL.ELEM_DELIM,

      EXTRACT_MODS_RE = RegExp('[^' + MOD_DELIM + ']' + MOD_DELIM + '(' + NAME_PATTERN + ')' + '(?:' + MOD_DELIM + '(' + NAME_PATTERN + '))?$'),

      buildModPostfix = INTERNAL.buildModPostfix, buildClass = INTERNAL.buildClass;
    ...
    {
      var domNode = domElem[0], params = getParams(domNode), blockName, blockParams;
    ...
    {
      block.domElem.length === 1 ? block._destruct(true) : block.domElem = block.domElem.not(domNode);
    }
    ...
    var DOM = BEM.decl('i-bem__dom', /** @lends DOM.prototype */{
      ...
      {
        fn ? domElem.bind(this._buildEventName(event), $.proxy(fn, this)) : objects.each(event, function (fn, event)
        {
      ...
      _buildOneEventName: function (event)
      {
        ...
        if (event.indexOf('.') < 0) {
          return eventNameCache[event] = event + uniq;
        }
      ...
      emit: function (e, data)
      {
        this.__base(e = this._buildEvent(e), data).domElem && this._ctxEmit(e, data);
      ...
      _ctxEmit: function (e, data)
      {
        ...
        {
          var ctx = this, counter = storage.counter;
          while (ctx && counter) {
      ...
      {
        var domNode = (elem || this.domElem)[0], matches;
      ...
      _onSetMod: function (modName, modVal, oldModVal, elem, elemName)
      {
        ...
        var _self = this.__self, classPrefix = _self._buildModClassPrefix(modName, elemName), classRE = _self._buildModValRE(modName, elemName), needDel = modVal === '' || modVal === false;

        (elem || this.domElem).each(function ()
        {
          var className = this.className, modClassName = classPrefix;
      ...
      findElem: function (ctx, names, modName, modVal, strictMode)
      {
        ...
        var _self = this.__self, selector = '.' + names.split(' ').map(function (name)
          ...
          }).join(',.'), res = findDomElem(ctx, selector);
      ...
      {
        var blockSelector = this.buildSelector(), domElem = this.domElem;
      ...
      {
        var key = name + buildModPostfix(modName, modVal), res;
      ...
      {
        var prev = ctx.prev(), parent = ctx.parent();

        this.destruct(ctx);

        this.init(prev.length ? $(content).insertAfter(prev) : $(content).prependTo(parent));
      },
      ...
      _buildLiveEventFn: function (callback, invokeOnInit)
      {
        ...
        return function (e)
        {
          ...
          var args = [
              _this._name, $(this).closest(_this.buildSelector()), true
      ...
      _liveInitOnBlockEvent: function (event, blockName, callback, findFnName)
      {
        ...
        {
          var args = arguments, blocks = e.target[findFnName](name);
      ...
      _liveCtxBind: function (ctx, e, data, fn, fnCtx)
      {
        if (typeof e === 'string') {
          ...
          if (e.indexOf(' ') > -1) {
            ...
            var ctxE = this._buildCtxEventName(e), storage = liveEventCtxStorage[ctxE] || (liveEventCtxStorage[ctxE] = { counter: 0, ctxs: {} });
      ...
      _liveCtxUnbind: function (ctx, e, fn, fnCtx)
      {
        ...
        if (storage) {
          ctx.each(function ()
          {
            var ctxId = identify(this, true), ctxStorage;
...
modules.define('jquery', ['loader_type_js', 'jquery__config'], function (provide, loader, cfg)
  {
    ...
    typeof jQuery !== 'undefined' ? doProvide() : loader(cfg.url, doProvide);
...
modules.define('loader_type_js', function (provide)
{
  ...
  var loading = {}, loaded = {}, head = document.getElementsByTagName('head')[0], onLoad = function (path)
    {
      loaded[path] = true;
  ...
  provide(function (path, cb)
  {
    ...
    script.onreadystatechange === null ? script.onreadystatechange = function ()
    {
...
(function (undefined)
{
  ...
  var _toString = Object.prototype.toString, escapable = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, meta = {
      '\b': '\\b',
      '\t': '\\t',
      '\n': '\\n',
      '\f': '\\f',
    ...
    stringify: stringify = function (val)
    {
      ...
      switch (_toString.call(val)) {
        case '[object String]':
          ...
          return '"' + (escapable.test(val) ? val.replace(escapable, function (a)
          {
            var c = meta[a];
...
;
/* ../../desktop.blocks/video-button/__max/video-button__max.browser.js begin */
/*global modules:false */

modules.define('video-button__max', function (provide)
{
...
/* ../../desktop.blocks/video-button/__max/video-button__max.browser.js end */
;
/* ../../desktop.blocks/video-button/__alex/video-button__alex.browser.js begin */
/*global modules:false */
...
/* ../../desktop.blocks/video-button/__alex/video-button__alex.browser.js end */
;
/* ../../desktop.blocks/video-button/__grig/video-button__grig.browser.js begin */
/*global modules:false */
...
/* ../../desktop.blocks/video-button/__grig/video-button__grig.browser.js end */
;
