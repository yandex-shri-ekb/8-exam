...
function buildBrowser() {
    ...
    copy({
        ...
        filter: [
            copy.filter.moduleDefines, removeAmdefine
        ],
...
function buildFirefox() {
    ...
    copy({
        ...
        filter: [
            copy.filter.moduleDefines, removeAmdefine, makeNonRelative
        ],
    ...
    copy({
        source: [
            'build/prefix-utils.jsm', 'build/assert-shim.js', {
                project: project,
    ...
    testFiles.forEach(function (testFile) {
        ...
        copy({
            source: [
                'build/test-prefix.js', path.join('test', 'source-map', testFile), 'build/test-suffix.js'
            ],
            filter: [
                removeAmdefine, makeNonRelative, function (input, source) {
