...
(function () {
    ...
    exports.Range = Range = (function (_super) {
        ...
        Range.prototype.compileNode = function (o) {
            ...
            condPart = this.stepNum ? +this.stepNum > 0 ? "" + lt + " " + this.toVar : "" + gt + " " + this.toVar : known ? ((_ref5 = [+this.fromNum, +this.toNum
            ], from = _ref5[0], to = _ref5[1], _ref5), from <= to ? "" + lt + " " + to : "" + gt + " " + to) : (cond = this.stepVar ? "" + this.stepVar + " > 0" : "" + this.fromVar + " <= " + this.toVar, "" + cond + " ? " + lt + " " + this.toVar + " : " + gt + " " + this.toVar);
    ...
    exports.Splat = Splat = (function (_super) {
        ...
        Splat.compileSplattedArray = function (o, list, apply) {
            ...
            for (i = _i = 0, _len = args.length; _i < _len; i = ++_i) {
                ...
                args[i] = node instanceof Splat ? [].concat(node.makeCode("" + (utility('slice')) + ".call("), compiledNode, node.makeCode(")")) :
    ...
    exports.In = In = (function (_super) {
        ...
        In.prototype.compileLoopTest = function (o) {
            ...
            fragments =
                [].concat(this.makeCode(utility('indexOf') + ".call("), this.array.compileToFragments(o, LEVEL_LIST), this.makeCode(", "), ref, this.makeCode(") " + (this.negated ? '< 0' : '>= 0')));
    ...
    exports.Try = Try = (function (_super) {
        ...
        Try.prototype.compileNode = function (o) {
            ...
            catchPart = this.recovery ? (placeholder = new Literal('_error'), this.errorVariable ? this.recovery.unshift(new Assign(this.errorVariable, placeholder)) : void 0, [
            ].concat(this.makeCode(" catch ("), placeholder.compileToFragments(o), this.makeCode(") {\n"), this.recovery.compileToFragments(o, LEVEL_TOP), this.makeCode("\n" + this.tab + "}"))) : !(this.ensure || this.recovery) ?
