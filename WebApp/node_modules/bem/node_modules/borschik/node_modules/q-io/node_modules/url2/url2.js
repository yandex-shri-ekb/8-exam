...
function relativeObject(source, target) {
    ...
    if (target.protocol === source.protocol && target.slashes === source.slashes && target.auth === source.auth && target.host === source.host) {
        ...
        if (!!target.root == !!source.root && !(
            target.root && target.directories[0] != source.directories[0]
            )) {
            delete target.path;
            delete target.root;
            ...
            if (target.directories.length === 0 && target.file === null && source.search) {
