var PATH = require('path'), DECL_SEP = '@';
...
module.exports = function (registry, environ) {
    ...
    registry.decl('Arch', {
        ...
        useLibraries: function (libs) {
            ...
            var repo = environ.getConf().libraries || {}, relative = PATH.relative.bind(null, this.root), getLibPath = environ.getLibPath;
        ...
        createBlockLibrariesNodes: function (parent) {
            var arch = this.arch, libs = this.__base.apply(this, arguments), libsNodeName = environ.LIB_DIR, node = new (registry.getNodeClass('Node'))(libsNodeName === '.' ? 'libs' : libsNodeName);

            arch.setNode(node).addChildren(node, libs);
