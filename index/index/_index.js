...
;
/* ..\..\desktop.blocks\video-block\video-block.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
...
/* ..\..\desktop.blocks\video-block\video-block.js end */
;
/* ..\..\desktop.blocks\persons\persons.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
    DOM.decl('persons', {
        onSetMod : {
...
/* ..\..\desktop.blocks\persons\persons.js end */
;
/* ..\..\desktop.blocks\person\person.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
    DOM.decl('person', {
        onSetMod : {
...
/* ..\..\desktop.blocks\person\person.js end */
;
/* ..\..\desktop.blocks\story-toggler\story-toggler.js begin */
modules.define('i-bem__dom', ['jquery'], function (provide, $, DOM) {
...
/* ..\..\desktop.blocks\story-toggler\story-toggler.js end */
;
...
;
/* ..\..\desktop.blocks\story-person\story-person.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
...
/* ..\..\desktop.blocks\story-person\story-person.js end */
;
/* ..\..\desktop.blocks\sidebar\sidebar.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
    DOM.decl('sidebar', {
        onSetMod : {
...
/* ..\..\desktop.blocks\sidebar\sidebar.js end */
;
/* ..\..\desktop.blocks\sidebar-toggle-button\sidebar-toggle-button.js begin */
modules.define('i-bem__dom', ['jquery'], function (provide, $, DOM) {
...
/* ..\..\desktop.blocks\sidebar-toggle-button\sidebar-toggle-button.js end */
;
/* ..\..\desktop.blocks\main-video\main-video.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
    //? popup
    DOM.decl('main-video', {
        onSetMod : {
...
/* ..\..\desktop.blocks\main-video\main-video.js end */
;
/* ..\..\desktop.blocks\overlay\overlay.js begin */
modules.define('i-bem__dom', ['jquery'], function(provide, $, DOM) {
    DOM.decl('overlay', {
        onSetMod : {
...
/* ..\..\desktop.blocks\overlay\overlay.js end */
;
